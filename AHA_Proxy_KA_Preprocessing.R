...
assets$MSkabels = assets$MSkabels[(assets$MSkabels$DateAdded > firstdate & assets$MSkabels$DateAdded < lastdate)| 
...
assets$LSkabels = assets$LSkabels[(assets$LSkabels$DateAdded > firstdate & assets$LSkabels$DateAdded < lastdate)| 
