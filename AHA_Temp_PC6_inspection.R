...
write.xlsx(row.sample(PCXY,100),file="Postcode_tests.xlsx")


renamestuff = function (data,addition)
  setnames(data,x,paste0(names(x),"_",addition))
)

# Take original BAR set
load("E:/1. Alliander/3. Asset Health Analytics/1. Ruwe Datasets/1. BARlog/MH_NRG_LS_KABELS.Rda")
BAR_source = mindataset
